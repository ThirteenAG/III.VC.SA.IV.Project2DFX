...
- **Grand Theft Auto: Vice City (US v1.0)**

## Installation

- Download and install [GTAVC Widescreen Fix](http://thirteenag.github.io/wfp#gtavc), it includes required [ASI Loader](https://github.com/ThirteenAG/Ultimate-ASI-Loader).
- Download [VC.Project2DFX](https://github.com/ThirteenAG/III.VC.SA.IV.Project2DFX/releases/download/gtavc/VC.Project2DFX.zip) and put all files to scripts folder.

## Screenshots

[![VC.Project2DFX](https://github.com/user-attachments/assets/1fb83748-1dc5-4bde-a545-6501e2f2d4d1)](https://www.youtube.com/watch?v=jwMd7FBC_ak)
