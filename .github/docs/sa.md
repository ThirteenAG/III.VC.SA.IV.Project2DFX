...
- **Grand Theft Auto: San Andreas (US v1.0)**

## Installation

- Download and install [GTASA Widescreen Fix](http://thirteenag.github.io/wfp#gtasa), it includes required [ASI Loader](https://github.com/ThirteenAG/Ultimate-ASI-Loader).
- Download [SA.Project2DFX](https://github.com/ThirteenAG/III.VC.SA.IV.Project2DFX/releases/download/gtasa/SA.Project2DFX.zip) and put all files to scripts folder.

## Screenshots

[![SA.Project2DFX](https://github.com/user-attachments/assets/1787b919-3874-454e-a6f8-bf791589596f)](https://www.youtube.com/watch?v=o8j6PzFjgbA)
